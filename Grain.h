...
class Grain : public Dessinable {
	...
	Grain(Vecteur3D const& p, Vecteur3D const& v, double m_v, double r, Milieu* const m, SupportADessin* sup)
...
class GrainLJ : public Grain {
	...
	GrainLJ(Vecteur3D const& p, Vecteur3D const& v, double m_v, double r, Milieu* const m, SupportADessin* sup)
...
class GrainLJ_1 : public GrainLJ {
	public:
	GrainLJ_1(Vecteur3D const& p = Vecteur3D(), Vecteur3D const& v = Vecteur3D(), double m_v = 1.0, double r = 0.4, Milieu* const m = new Air, SupportADessin* sup = nullptr)
...
class GrainLJ_2 : public GrainLJ {
	public:
	GrainLJ_2(Vecteur3D const& p = Vecteur3D(), Vecteur3D const& v = Vecteur3D(), double m_v = 1.0, double r = 0.4, Milieu* const m = new Air, SupportADessin* sup = nullptr)
	: GrainLJ(p,v,m_v,r,m,sup)
	{
		tg = LJ2;
	}
